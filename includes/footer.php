                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-menu clearfix">
                              <ul>
                              <?php
                                $sql = "SELECT * FROM `cs_footer_quick_link` ORDER BY `created_at` DESC";
                                $reSql = mysqli_query($con,$sql);
                                while($quick_link = mysqli_fetch_array($reSql)){
                               ?>
                                <li><a href="<?php echo $quick_link['quick_link_url']; ?>"><?php echo $quick_link['quick_link_title']; ?></a></li>
                              <?php } ?>
                              </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-contact-list">
                                <div class="single-footer-contact-info">
                                    ...
                                    <span class="footer-contact-list-text"><?php echo $value['phone'] ?></span>
                                </div>
                                <div class="single-footer-contact-info">
                                    <span class="ti-email "></span>
                                    <span class="footer-contact-list-text"><?php echo $value['email'] ?></span>
                                </div>
                                <div class="single-footer-contact-info">
                                    <span class="ti-location-pin"></span>
                                    <span class="footer-contact-list-text"><?php echo $value['address'] ?></span>
                                </div>
                            </div>
                            <div class="opening-time">
                                <span>Opening Hour</span>
                                <span class="opening-date">
                                    <?php echo $value['open_day'] ?>: <?php echo $value['open_time'] ?>- <?php echo $value['close_time'] ?>
                                </span>
                            </div>
                        </div>
                    </div>
