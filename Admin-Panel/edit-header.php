        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder=""value="<?php echo $value['phone'];?>" name="phone">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Header Email</label>
                    <div class="col-sm-8">
                        <input type="email" class="form-control" placeholder="" value="<?php echo $value['email'];?>" name="email">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Facebook Url</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="" <?php echo $value['phone'];?> name="fb_url">
                    </div>
                </div>
                <div class="form-group">
