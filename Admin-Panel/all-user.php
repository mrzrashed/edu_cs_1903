    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-responsive table-striped table-hover table_cus">
                ...
                <tbody>
                  <?php
                    $query = "SELECT * FROM `cs_user` NATURAL JOIN cs_role order by user_id DESC";
                  ...
                  ?>
                    <tr>
                        ...
                        <td class="hidden-xs"><?php echo $value['role_name']; ?></td>
                        <td class="hidden-xs">
                          <?php
                              if ($value['user_photo']!='') {
                           ?>
                          <img src="uploads\<?= $value['user_photo']?>" height="40" alt="">
                          <?php
                              }
                              else {
                           ?>
                        ...
                        <td>
                            ...
                            <a href="view-user.php?v=<?= $value['user_id']; ?>"><i class="fa fa-plus-square fa-lg"></i></a>
