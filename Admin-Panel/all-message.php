            ...
            <table class="table table-responsive table-striped table-hover table_cus">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <td><?php echo substr($value['conus_name'],0,10);?></td>
                        <td><?php echo $value['conus_email']; ?></td>
                        <td><?php echo $value['conus_phone']; ?></td>
                        <td><?php echo substr($value['conus_sub'],0,10); ?>....</td>
                        <td class="hidden-xs"><?php echo substr($value['conus_mess'],0,40);?>....</td>
                        <td>
