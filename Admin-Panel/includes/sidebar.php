          ...
          <div class="side_user">
            ...
            <ul>
              ...
              <?php } ?>
                ...
                <li><a href="home.php"><i class="fa fa-home"></i>Home Page</a></li>
                <li><a href="#"><i class="fa fa-book"></i>Course Page</a></li>
                <li><a href="#"><i class="fa fa-address-card"></i>About Page</a></li>
                <li><a href="#"><i class="fa fa-id-badge"></i>Contact Page</a></li>
